...
<template>
                ...
                <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                  ...
                  <nav class="flex flex-1 flex-col">
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                      ...
                      <li>
                        <div class="text-xs font-semibold leading-6 text-gray-400">External Links</div>
                      ...
                      <li class="mt-auto">
                        <a href="https://github.com/grant-king/trc-campersguide/" class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50 hover:text-indigo-600">
                          <img class="h-6 w-6" src="@/assets/github-mark.svg" alt="GitHub Link" />
                          Update
                        </a>
                      </li>
                    </ul>
        ...
        <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
          ...
          <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <form class="relative flex flex-1" action="#" method="GET">
              ...
              <input id="search-field" class="block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm" placeholder="Search... (Coming Soon)" type="search" name="search" />
            </form>
              ...
              <!-- 
                <Menu as="div" class="relative">
                    <MenuButton class="-m-1.5 flex items-center p-1.5">
                        ...
                        <img class="h-8 w-8 rounded-full bg-gray-50" src="@/assets/admin.webp" alt="" />
  ...
  const teams = [
    ...
    { id: 2, name: 'TRC Greenbook', href: 'https://drive.google.com/file/d/1IiVnL0AHmljm19ulyS-mmTzYiYL8Cn5x/view', initial: 'GBK', current: false },
    { id: 3, name: 'TRC Facebook', href: 'https://www.facebook.com/camptrc/', initial: 'FBK', current: false },
  ]
  const userNavigation = [
    { name: 'Ask Admin', href: 'mailto:secretary@camptrc.org' },
    { name: 'Ask Website (coming soon)', href: '#' },
  ]
